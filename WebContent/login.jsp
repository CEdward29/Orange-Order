	...
	<div class="container clrfix"> 
		...
		<div class="panel"> 
    		...
    		<div class="panel-bd"> 
    			...
    			<div class="form-item"> 
    				<input name="username" class="inputbox" required="" type="text" placeholder="用户名/电子邮箱/手机号" minlength="5"> 
       				<div class="g-error-tip hide"></div> 
    			</div> 
    			<div class="form-item"> 
       				<input name="password" class="inputbox" required="" type="password" maxlength="20" placeholder="密码" minlength="6"> 
       				<div class="g-error-tip hide"></div> 
    			</div> 
